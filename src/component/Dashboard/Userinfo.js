      ...
      <div className="userinfo">
        ...
        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          ...
          <div className="equity col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <div>
              <div className="equity-left-panel col-xs-12 col-sm-12 col-md-6 col-lg-6">
                <p className={this.getClass(this.props.userStockData.marketValue,
                  this.props.userStockOldData.marketValue)}>{this.props.userStockData.unrealisedPl}k
                    <span className="percentgeval">({this.props.userStockData.unrealisedPlChange}%)</span>
                </p>
                <h3>Available Balance</h3>
              </div>
              <div className="equity-right-panel col-xs-12 col-sm-12 col-md-6 col-lg-6">
